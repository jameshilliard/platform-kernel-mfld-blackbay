...
make -s ARCH=%{kernel_arch} tizen_bb_defconfig
...
# Install TI WLAN (out-of-tree) drivers
ARCH=%{kernel_arch} TARGET_TOOLS_PREFIX="" INSTALL_MOD_PATH=%{buildroot} ./wl12xx-compat-build.sh -c mfld_pr2 %{?_smp_mflags} -i KERNELRELEASE=%{kernel_full_version}
